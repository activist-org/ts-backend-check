...
- The user is now able to use comments to indicate which fields in the model are being inherited from other classes and whether these fields are nullable (`#51 <https://github.com/activist-org/ts-backend-check/issues/51>`_).
